...
$required = @(
  ...
  'scripts/evaluate-ai-review.ps1','scripts/request-machine-review.ps1','scripts/request-review-repair.ps1','scripts/reconcile-machine-review-threads.ps1','scripts/pr-orchestrator.ps1','scripts/lint-pr-creation.ps1','scripts/review-metrics.ps1','scripts/prune-portfolio.ps1',
