...
- blocking P0/P1 evidence — if any already exists on the PR, e.g. a review left by hand — still fails the check;
- P2-only evidence is recorded once as a deduplicated advisory Issue, updated in place across later heads, and never blocks;
